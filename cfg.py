...
__C.ship_classes = ['ship','aircraft-carrier']

__C.tank_classes = ['ship','1030102','10301030102']

__C.haisi_classes = ['ship','oil-tank','bridge','airplane']
...
def __configure_data(dataopt):
    ...
    if dataopt['data'] == 'dota':
        ...
        __C.save_interval = 50
    elif dataopt['data'] == 'dior':
        __C.classes = __C.dior_classes
        __C.save_interval = 100
    elif dataopt['data'] == 'plane':
        __C.classes = __C.plane_classes
        __C.save_interval = 10
    elif dataopt['data'] == 'ship':
        __C.classes = __C.ship_classes
        __C.save_interval = 10
    elif dataopt['data'] == 'tank':
        __C.classes = __C.tank_classes
        __C.save_interval = 50
    elif dataopt['data'] == 'haisi':
        __C.classes = __C.haisi_classes
        __C.save_interval = 10
    ...
    if __C.tuning:
        if dataopt['data'] in ['dota', 'nwpu', 'dior', 'plane','ship','tank','haisi']:
