    ...
    while True:
        ...
        if line:
            ...
            if len(splitlines) == 9:
                ...
                # else:
                #     object_struct['difficult'] = 0
            xmin = min(float(splitlines[0]),float(splitlines[2]), float(splitlines[4]),float(splitlines[6]))
            ymin = min(float(splitlines[1]),float(splitlines[3]),float(splitlines[3]),float(splitlines[7]))
            xmax = max(float(splitlines[0]),float(splitlines[2]), float(splitlines[4]),float(splitlines[6]))
            ymax = max(float(splitlines[1]), float(splitlines[3]), float(splitlines[3]), float(splitlines[7]))
            # object_struct['poly'] = [(float(splitlines[0]), float(splitlines[1])),
            #                          (float(splitlines[2]), float(splitlines[3])),
            #                          (float(splitlines[4]), float(splitlines[5])),
            #                          (float(splitlines[6]), float(splitlines[7]))
            #                          ]
            object_struct['poly'] = [(xmin, ymin),
                                     (xmax, ymin),
                                     (xmax, ymax),
                                     (xmin, ymax)
                                     ]
